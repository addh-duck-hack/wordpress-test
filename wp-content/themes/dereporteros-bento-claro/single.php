...
<article class="single-wrap">
	...
	<script>
	( function () {
		// Los botones de Facebook/X/WhatsApp abren en una ventana emergente
		// pequeña y centrada (en vez de una pestaña nueva) para que el
		// usuario no pierda de vista la nota. El correo (mailto) no aplica.
		var links = document.querySelectorAll( '.share-btn[data-popup]' );
