...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_script(
		'dereporteros-nocturno-directo-ticker',
...
if ( ! function_exists( 'dereporteros_ticker_category_name' ) ) {
	 ...
	 * la primera categoría de la entrada que no sea "ultima-hora" (para
	 * no repetir esa misma etiqueta), con fallback al nombre real de esa
